...
**测试日期**：2026-07-21 **测试版本**：1.1.10 **测试框架**：Deno 内置测试框架 +
Bun 测试框架
...
| ------------ | ------------------------------------ |
| 测试文件数   | 21                                   |
| 总测试用例数 | Deno 406 / Bun 367（含 skip/ignore） |
| 通过用例数   | Deno **404** / Bun **365**           |
| 跳过/忽略    | Deno **2** ignored / Bun **2** skip  |
| 失败用例数   | **0**（双运行时）                    |
| 通过率       | 非跳过用例 100%                      |
| 测试执行时间 | Deno 全量约 60s / Bun 全量约 45s     |
| 代码覆盖     | 全面覆盖                             |
